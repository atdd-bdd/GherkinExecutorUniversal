...
namespace gherkinexecutor {
    ...
    public:
        ...
        virtual void actOnData(const std::vector<std::string>& words);
        virtual void endOneDataFile();
        virtual std::string alterDataType(const std::string& s);
    ...
    protected:
        ...
        void endDataFile();
        void createVariableList(const std::vector<std::string>& table,
                                std::vector<DataValues>& variables, bool& doInternal);
    ...
    private:
        ...
        void createConversionMethod(const std::string& internalClassName,
                                    const std::vector<DataValues>& variables, const std::string& className);
        ...
        void createInternalClassEmpty(const std::string& className, const std::string& otherClassName,
                                      const std::vector<DataValues>& variables, bool providedClassName);
        void createDataTypeToStringObject(const std::string& className, const std::vector<DataValues>& variables);
        void createToStringObject(const std::string& className, const std::string& otherClassName,
